...
export const createRiskAssessmentSchema = z
    ...
    deadline: z.date().optional().or(z.string().datetime().optional()),
})
    .refine((data) => {
    // Calculate Ri and R
    ...
    message: 'Резидуални ризик (R) мора бити мањи од иницијалног ризика (Ri). Корективне мере нису ефикасне.',
    path: ['e'], // Show error on residual E field
});
export const updateRiskAssessmentSchema = createRiskAssessmentSchema.partial().extend({
